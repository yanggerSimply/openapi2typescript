...
const generateService = (_a) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const serviceGenerator = new serviceGenerator_1.ServiceGenerator(Object.assign({ namespace: 'API', requestImportStatement, enumStyle: 'string-literal' }, rest), openAPI);
